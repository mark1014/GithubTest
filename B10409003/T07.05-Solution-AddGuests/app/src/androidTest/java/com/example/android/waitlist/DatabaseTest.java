...
public class DatabaseTest {
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_GENDER, "gender");
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, 200);
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_AGE, 200);
    ...
    public void autoincrement_test() throws Exception{
        ...
        ContentValues testValues = new ContentValues();
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, "test name");
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_GENDER, "male");
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, 200);
        testValues.put(WaitlistContract.WaitlistEntry.COLUMN_AGE, 200);
